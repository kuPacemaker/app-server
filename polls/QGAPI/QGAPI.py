        ...
        if(user_token):
            ...
            if(unit):
                ...
                if(user_token[0].user_id == host[0].user.id):
                    ...
                    news_body = "A question was generated by "+bkd.title+" in Unit"+repr(news_for_unit.index)+" "+news_for_unit.name+" of "+news_for_channel.name 
                    print(news_body)
                    news = News.objects.create(title = news_title, body = news_body, channel = news_for_channel, unit = news_for_unit)
